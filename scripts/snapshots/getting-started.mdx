---
title: "Start here"
description: "Three commands keep a model and talk to it. This page walks through them with a tiny Hub repo so the first success is measured in seconds, then shows the same path on a real model."
editUrl: "https://github.com/darsay-io/darsay/edit/main/docs/GETTING-STARTED.md"
---
