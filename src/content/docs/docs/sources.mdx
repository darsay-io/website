...
description: "estimate and archive take a source ref. Hugging Face is the first provider, not the product."
editUrl: "https://github.com/darsay-io/darsay/edit/main/docs/SOURCES.md"
---
...
([Catalogs](/docs/catalogs/#entry), [Concepts → closed works](/docs/concepts/#closed-works)).
