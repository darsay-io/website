...
[Contributing](https://github.com/darsay-io/darsay/blob/aaec0cade9542d4e5fa22bc526a98696fe60746e/CONTRIBUTING.md) for how,
...
| [**Quantization**](/docs/quantization/) | Masters-first archiving, `darsay classify`, satellite quants, derived precision |
| [**Catalogs**](/docs/catalogs/) | Shareable want-lists; darsay.io boards as remote catalogs; the vault is the same list, realized |
...
a schema / format version bump. See [Contributing](https://github.com/darsay-io/darsay/blob/aaec0cade9542d4e5fa22bc526a98696fe60746e/CONTRIBUTING.md).
