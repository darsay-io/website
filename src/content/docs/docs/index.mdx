...
[Contributing](https://github.com/darsay-io/darsay/blob/14e824b9089320b4f9d0cf384f56d6ac076e54b9/CONTRIBUTING.md) for how,
...
| [**Incremental transfer**](/docs/incremental/) | Budgets, Ctrl-C, Range partials, the free-space floor and `config.toml`, `--shard N/T`, `assemble` |
...
a schema / format version bump. See [Contributing](https://github.com/darsay-io/darsay/blob/14e824b9089320b4f9d0cf384f56d6ac076e54b9/CONTRIBUTING.md).
