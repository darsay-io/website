...
description: "pipx install darsay (or uvx darsay with no install). Isolated CLI, pure-Python wheel, one runtime dependency."
editUrl: "https://github.com/darsay-io/darsay/edit/main/docs/DISTRIBUTION.md"
---
